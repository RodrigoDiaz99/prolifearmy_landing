    ...
    <div class="flex w-full max-w-md">
        <ul class="flex flex-col w-full">
            ...
            <li class="my-px">
                ...
                <li class="my-px">
                    <a href="{{route('dashboard_content')}}"
                        class="flex flex-row items-center h-12 px-4 rounded-lg hover:bg-gray-600">
                        <span class="flex items-center justify-center text-lg text-blue-500">
                            <i class="fas fa-cog"></i>
                        </span>
                        <span class="ml-3">Editar pagina inicial</span>
                    </a>
                </li>
                ...
                <li class="my-px">
                    <a href="{{route('article_show')}}"
                        ...
                        <span class="ml-3">Panel de articulos</span>
                    </a>
                </li>
                <li class="my-px">
                ...
                <li class="my-px">
                    <a href="{{route('conference_show')}}"
                        ...
                        <span class="ml-3">Panel de conferencias</span>
                    </a>
                </li>
